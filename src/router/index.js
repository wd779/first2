...
const routes = [
  {
    ...
    children: [
      ...
      { path: "practice", name: "Practice", component: () => import("../views/practice/Practice.vue"), meta: { title: '练习页面' } },// 练习页面主页面-zhy
      ...
      { path: "shu", name: "shu", component: () => import("../views/practice/shu.vue"), meta: { title: '学习' } },// 学习跳转页面-zhy
      { path: "hua", name: "hua", component: () => import("../views/practice/hua.vue"), meta: { title: '化学' } },// 化学跳转页面-zhy
      { path: "order", name: "order", component: () => import("../views/order/order.vue"), meta: { title: '约课记录' } },// 约课记录主页面-zhy
    ]
  }, // 主页面
  ...
  { path: '/my-study', name: 'My-study', component: () => import('../views/my/My-study.vue'), meta: { title: '我的学习' } }, // 我的特色课 我的学习
  { path: '/my-currency', name: 'My-currency', component: () => import('../views/my/My-currency.vue'), meta: { title: '我的特色课' } }, // 我的特色课 我的学习
  { path: '/collect', name: 'Collect', component: () => import('../views/my/Collect.vue'), meta: { title: '我的收藏' } }, // 我的收藏
  { path: '/concern', name: 'Concern', component: () => import('../views/my/Concern.vue'), meta: { title: '关注的老师' } }, // 我的关注 关注的老师
  ...
  { path: '/setPass', name: 'setPass', component: () => import('../views/my/setPass.vue'), meta: { title: '设置密码' } }, // 设置密码页面-zhy
